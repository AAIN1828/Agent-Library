"""Env-driven Azure OpenAI config for Full Document Generator (from-scratch PDF generator)."""
...
def require_env(name: str) -> str:
    ...
    if not value:
        raise RuntimeError(
            ...
            "Configure it before running Full Document Generator "
            "(see full_document_generator/runtime_config.py)."
        )
    return value
